...
(function ($) {
	...
	$._chromeExtensionRequiredVersion = '2.7.0';
	$._firefoxExtensionRequiredVersion = '2.7.0';
	$._chromeNativeWinRequiredVersion = '2.3.0';
	$._chromeNativeLinuxRequiredVersion = '2.5.0';
	$._chromeNativeMacRequiredVersion = '2.5.0';
	$._ieAddonRequiredVersion = '2.1.1';
